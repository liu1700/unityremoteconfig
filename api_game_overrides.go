...
type ApiCreateGameOverrideRequest struct {
	ctx context.Context
...
func (r ApiCreateGameOverrideRequest) Campaign(campaign Campaign) ApiCreateGameOverrideRequest {
	r.campaign = &campaign
	return r
}

func (r ApiCreateGameOverrideRequest) Execute() (*CreateCampaignResponse, *http.Response, error) {
	return r.ApiService.CreateGameOverrideExecute(r)
}

/*
CreateGameOverride Create a game override

Create a new game override


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId Genesis projectId
 @return ApiCreateGameOverrideRequest
*/
func (a *GameOverridesAPIService) CreateGameOverride(ctx context.Context, projectId string) ApiCreateGameOverrideRequest {
	return ApiCreateGameOverrideRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *GameOverridesAPIService) CreateGameOverrideExecute(r ApiCreateGameOverrideRequest) (*CreateCampaignResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GameOverridesAPIService.CreateGameOverride")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/remote-config/v1/projects/{projectId}/environments/{environmentId}/campaigns"
...
type ApiGetAllGameOverridesRequest struct {
	ctx context.Context
	ApiService *GameOverridesAPIService
	projectId string
...
func (r ApiGetAllGameOverridesRequest) Execute() (*GetAllCampaignsResponse, *http.Response, error) {
	return r.ApiService.GetAllGameOverridesExecute(r)
}

/*
GetAllGameOverrides Get all game overrides

Returns all game overrides for a given project and environment

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId Genesis projectId
 @param environmentId Genesis environmentId
 @return ApiGetAllGameOverridesRequest
*/
func (a *GameOverridesAPIService) GetAllGameOverrides(ctx context.Context, projectId string, environmentId string) ApiGetAllGameOverridesRequest {
	return ApiGetAllGameOverridesRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *GameOverridesAPIService) GetAllGameOverridesExecute(r ApiGetAllGameOverridesRequest) (*GetAllCampaignsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetAllCampaignsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GameOverridesAPIService.GetAllGameOverrides")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

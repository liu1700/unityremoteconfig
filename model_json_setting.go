...
// checks if the JsonSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JsonSetting{}

// JsonSetting struct for JsonSetting
...
func (o JsonSetting) MarshalJSON() ([]byte, error) {
...
func (o JsonSetting) ToMap() (map[string]interface{}, error) {
...
type NullableJsonSetting struct {
	value *JsonSetting
	isSet bool
}

func (v NullableJsonSetting) Get() *JsonSetting {
	return v.value
}

func (v *NullableJsonSetting) Set(val *JsonSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableJsonSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableJsonSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJsonSetting(val *JsonSetting) *NullableJsonSetting {
	return &NullableJsonSetting{value: val, isSet: true}
}

func (v NullableJsonSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJsonSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true

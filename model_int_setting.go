...
// checks if the IntSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntSetting{}

// IntSetting struct for IntSetting
...
func (o IntSetting) MarshalJSON() ([]byte, error) {
...
func (o IntSetting) ToMap() (map[string]interface{}, error) {
...
type NullableIntSetting struct {
	value *IntSetting
	isSet bool
}

func (v NullableIntSetting) Get() *IntSetting {
	return v.value
}

func (v *NullableIntSetting) Set(val *IntSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableIntSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableIntSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntSetting(val *IntSetting) *NullableIntSetting {
	return &NullableIntSetting{value: val, isSet: true}
}

func (v NullableIntSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response{}

// RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response struct for RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response
type RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response struct {
...
func NewRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response() *RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response {
	this := RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response{}
	return &this
}
...
func (o RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) MarshalJSON() ([]byte, error) {
...
func (o RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response struct {
	value *RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response
	isSet bool
}

func (v NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) Get() *RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response {
	return v.value
}

func (v *NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) Set(val *RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response(val *RemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) *NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response {
	return &NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response{value: val, isSet: true}
}

func (v NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConfigV1ProjectsProjectIdConfigsCopytoPost404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
